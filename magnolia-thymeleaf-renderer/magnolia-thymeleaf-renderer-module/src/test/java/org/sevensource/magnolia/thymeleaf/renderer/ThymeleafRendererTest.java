...
public class ThymeleafRendererTest extends MagnoliaThymeleafMockSupport {
	...
	@Test
	public void test_url() throws RenderException, RepositoryException {
		ThymeleafRenderer renderer = new ThymeleafRenderer(engine, templatingFunctions);
		
		renderer.onRender(node, renderableDefinition, renderingContext, Collections.emptyMap(), "test_url.html");
		String result = stringWriter.toString();
		assertTrue("fragment was not selected", result.trim().startsWith("<div"));
	}
}
